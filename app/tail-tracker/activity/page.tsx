...
const mockActivityData: ActivityEntry[] = [
  { id: 1, date: '2023-06-15', activityType: 'Walk', duration: 30, distance: 2.5 },
  { id: 2, date: '2023-06-15', activityType: 'Play', duration: 15 },
  { id: 3, date: '2023-06-16', activityType: 'Run', duration: 20, distance: 3.2 },
  { id: 4, date: '2023-06-16', activityType: 'Rest', duration: 120 },
  { id: 5, date: '2023-06-17', activityType: 'Walk', duration: 45, distance: 3.8 },
  { id: 6, date: '2023-06-17', activityType: 'Play', duration: 25 },
  { id: 7, date: '2023-06-18', activityType: 'Walk', duration: 35, distance: 2.9 },
  { id: 8, date: '2023-06-18', activityType: 'Run', duration: 15, distance: 2.1 },
  { id: 9, date: '2023-06-19', activityType: 'Walk', duration: 40, distance: 3.3 },
...
export default function ActivityHistoryPage() {
  ...
  const filteredData = filter === 'all' 
    ? activityData 
    : activityData.filter(entry => entry.activityType.toLowerCase() === filter)
  ...
  const chartData = activityData.reduce((acc, entry) => {
    ...
    if (existingEntry) {
      ...
      acc.push({
        date: entry.date,
        walkDuration: entry.activityType === 'Walk' || entry.activityType === 'Run' ? entry.duration : 0,
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold text-emerald-400 neon mb-6">TailTracker Activity History</h1>
      <Card className="mb-6">
        <CardHeader>
            ...
            <TableBody>
              {filteredData.map((entry) => (
                <TableRow key={entry.id}>
                  ...
                  <TableCell>{entry.distance?.toFixed(2) || 'N/A'}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
